    ...
    return (
      <div>
        ...
        <form className='flex flex-col w-[580px]'>
          <label className='mb-3 text-sm'>Deixe seu nome e e-mail abaixo para acessar o curso e o certificado <span className='font-bold'>gratuitamente:</span></label>
      ...
      <div >
        <img className='m-auto' src={imagemHeader}/>
      </div>
    </div>
    )
}
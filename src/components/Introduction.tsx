...
export default function Introduction () {
    return (
      <div className='md:w-[1300px] mx-auto'>
        <div className='absolute flex flex-col gap-8 md:gap-12 text-white p-4 md:p-16'>
        ...
        <div className='w-[50%] md:font-medium md:text-3xl md:w-[600px]'>
        ...
        <div className='flex gap-6 my-5 md:my-0 justify-center md:justify-start'>
          <img src={calendario} className='w-[50px] md:w-[80px]' alt="imagem calendário"/>
          <div className='flex flex-col font-bold md:font-normal md:text-2xl'>

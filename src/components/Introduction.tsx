    ...
    return (
      <div className='md:w-[1300px] mx-auto'>
        <div className='absolute flex flex-col gap-8 md:gap-12 text-white p-6 md:p-16'>
          <div className='text-[21px] text-center md:text-start md:text-4xl font-black'>
            <h1>AS INOVAÇÕES E AVANÇOS MAIS</h1>
            <h1>RECENTES DO <span className='text-[#FDE936]'>MARKETING DIGITAL</span></h1>
          </div>
        <div className='w-[45%] font-bold md:font-medium md:text-3xl md:w-[600px]'>
        ...
        <div className='flex gap-6 my-7 md:my-0 justify-center md:justify-start'>
          <img src={calendario} className='w-[70px] md:w-[80px]' alt="imagem calendário"/>
          <div className='flex flex-col font-bold text-xl justify-center md:font-normal md:text-2xl'>
            <p>Dia 18/04/23 (terça-feira)</p>
            <p>20:00h (horário de Brasília)</p>
          </div>
        </div>

        <form className='flex flex-col md:w-[580px]'>
          <label className='mb-3 text-[18px] md:text-[15px] text-center md:text-start'>Deixe seu nome e e-mail abaixo para acessar o curso e o certificado <span className='font-bold text-lg'>gratuitamente:</span></label>

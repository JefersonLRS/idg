...
export default function Profile() {
    return (
        <div className='flex flex-col md:w-[1300px] md:mx-auto md:flex-row justify-center items-center gap-6 md:gap-[100px] mb-[30px] md:mb-[100px]'>
        <img src={imagemIrmaos} alt="Imagem dos irmãos rocha" />
        <div className='text-white w-[80%] md:w-[40%] flex flex-col gap-7'>
          <h1 className='text-3xl md:text-5xl font-bold'>Erico e Hugo Rocha</h1>

  ...
  return (
    <div className='flex flex-col justify-center'>
      ...
      <div className='flex flex-col justify-center mt-[100px]'>
        ...
        <div className='mt-[150px] mx-auto grid gap-[70px] grid-cols-1 md:grid-cols-2'>

          <div className='flex flex-col justify-center items-center gap-4 w-[250px]'>
...
digital nos últimos 6 meses</p>
          ...
          <div className='flex flex-col justify-center items-center gap-4 w-[250px]'>
            <img src={faixaIcon} className='w-24' alt="Cadeado icone"/>
